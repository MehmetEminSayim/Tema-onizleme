    ...
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="<?php echo base_url("contract/save"); ?>" method="post">
                    <div class="form-group">

                        <label>Sözleşme Adı</label>
                        <input  class="form-control" name="contract_name">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="contract_description" class="m-0" data-plugin="summernote" data-options="{height: 250}"></textarea>
                    </div>
